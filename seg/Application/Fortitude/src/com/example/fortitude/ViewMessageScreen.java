...
public abstract class ViewMessageScreen extends Window 
{
	...
	public ViewMessageScreen(String senderx, String subjectx, String contentx, int notificationIdx, int goToPagex)
	{
		...
		reportIcon.setOnClickListener(new OnClickListener() {
			public void onClick(View arg0)
			{
				...
				NotificationStub fakeStub = new NotificationStub(notificationId, 0, 0, "", "", "", "");
				new ReportScreens(3, fakeStub) {
	...
	private GridLayout createContentPane()
	{
		...
		senderTextView.setOnClickListener(new OnClickListener() {
			public void onClick(View Arg0)
			{
				...
				ServerRequests.getUserInfo(sender, true);
						...
						if(ServerRequests.getGetUserInfoSuccess())
						{
							Fortitude.getFortitude().runOnUiThread(new Runnable() {
								public void run()
								{
									...
									ViewMessageScreen.getMe().killMe();
									new EnemyProfileScreen(ServerRequests.getStaticUserInfo().get(0), null, 1);
								}
							});
						}
					}
