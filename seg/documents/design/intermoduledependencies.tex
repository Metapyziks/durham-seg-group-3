...
\begin{figure}[h!]
    \centering
    \begin{tabular}{c}
        \entity{external}[\TabM{C{3cm}}{External Modules}]
        \hspace{2cm}
...
The module will be used extensively by the other modules in the server, so considerable effort has been invested in designing a clean and powerful interface.
