...
$ctf_thank_you .= '
<div class="respondPadding"><div '.$this->si_contact_convert_css($si_contact_opt['redirect_style']).'>
';
...
$ctf_thank_you .= '
  <br /><br />
  <a href="'.$ctf_redirect_url.'">'.__('Please click here to continue', 'si-contact-form').'</a>';
}
$ctf_thank_you .= '
</div></div>';
